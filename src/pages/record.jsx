...
export default function Record() {
  ...
  return (
    ...
    >
      ...
      >
        <h2 style={{ color: "#ecf0f1", textAlign: "center", marginBottom: "20px" }}>Service Record 🧾</h2>
        ...
        <div style={{ marginBottom: "20px" }}>
          <div style={{ marginBottom: "10px" }}>
            <input
              ...
              style={{ padding: "10px", borderRadius: "5px", border: "none", color: "#2c3e50", width: "100%" }}
            />
          </div>
          <div style={{ marginBottom: "10px" }}>
            <input
          ...
          <div style={{ marginBottom: "10px" }}>
            <select value={serviceCode} onChange={(e) => setServiceCode(e.target.value)} style={{ padding: "10px", borderRadius: "5px", border: "none", color: "#2c3e50", width: "100%" }}>
          ...
          <div style={{ marginBottom: "10px" }}>
            <select value={plateNumber} onChange={(e) => setPlateNumber(e.target.value)} style={{ padding: "10px", borderRadius: "5px", border: "none", color: "#2c3e50", width: "100%" }}>
              ...
              {cars.map((c) => (
                <option key={c.plate_number} value={c.plate_number}>{c.plate_number}</option>
              ))}
            </select>
          </div>
          <div style={{ marginBottom: "10px" }}>
        ...
        <div>
          {records.length === 0 ? (
            <p style={{ color: "#ecf0f1" }}>No records yet</p>
          ) : (
            records.map((r) => (
              <div
                key={r.recordNumber}
